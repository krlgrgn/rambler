...
describe ConversationsController do
  ...
  pending "Write some conversation controller tests."
...
#        post :create, {:conversation => { "message_box_id" => "invalid value" }}, valid_session
#        assigns(:conversation).should be_a_new(Conversation)
#      end
#
...
#        Conversation.any_instance.should_receive(:update_attributes).with({ "message_box_id" => "1" })
#        put :update, {:id => conversation.to_param, :conversation => { "message_box_id" => "1" }}, valid_session
#      end
#
#      it "assigns the requested conversation as @conversation" do
#        conversation = Conversation.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Conversation.any_instance.stub(:save).and_return(false)
#        put :update, {:id => conversation.to_param, :conversation => { "message_box_id" => "invalid value" }}, valid_session
#        assigns(:conversation).should eq(conversation)
#      end
#
